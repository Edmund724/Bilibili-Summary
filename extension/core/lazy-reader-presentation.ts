...
// / renderReadingStatus / buildReaderStepperControl / bindReaderStepperControl 等函数。
// 它们在普通页启动路径被 content.js 与 init-essentials.js 静态引用，会把 validators
// 及步进器模板/绑定逻辑拖入常驻。本模块把它改为动态 import 边：普通页不加载，
