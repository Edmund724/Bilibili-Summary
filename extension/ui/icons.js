// ui/icons.js — inline SVG 图标构建函数。
// AI 播放器快捷动作图标原在 ai/player-ai.js；阅读视图 header 图标原在
// ui/ui-renderer.js。均为纯函数，不依赖 DOM/全局状态。

export function buildPlayerAiQuickActionIconSvg(variant = "badge") {
  const variants = {
    badge: `
